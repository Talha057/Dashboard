...
function menuClick(event) {
  ...
  // const sideMenuItems = ["dashboard", "goals", "courses", "support", "account"];
  // sideMenuItems.forEach((item) => {
  //   document.getElementById(item).querySelector("div").style.color = "#268EC2";
  // });

  // // Change the clicked item to green color
  // event.target.style.color = "#8AB428";
  var sideMenu = document.getElementById("sideMenu");
  sideMenu.classList.toggle("hidden");
}
